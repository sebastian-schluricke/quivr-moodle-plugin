...
/**
 * API endpoint to get a mybrainchat instance for a course
 *
...
require_once($CFG->dirroot . '/mod/mybrainchat/lib.php');
...
$PAGE->set_url('/mod/mybrainchat/api/get_instance.php', ['courseid' => $courseid]);
