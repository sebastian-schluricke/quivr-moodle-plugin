...
/**
 * External service to clear the chat session (for "New Chat").
 *
...
class clear_session extends external_api {
    ...
    public static function execute(int $cmid): array {
        ...
        unset($_SESSION['quivrchat_chatid_' . $cmid]);
        unset($_SESSION['quivrchat_history_' . $cmid]);
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            'success' => new external_value(PARAM_BOOL, 'Whether the session was cleared'),
        ]);
    }
}
