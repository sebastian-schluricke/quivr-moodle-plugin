# TODO: Moodle Plugin quivrchat

## Thumbs Feedback Feature

**Status:** Deaktiviert (Button auskommentiert in `quivr-chat.js`)
...
| CSS Styles | Vorhanden (`styles/quivr-chat.css`) |
...
1. **message_id aus Stream extrahieren und speichern**
   ...
   - Relevante Stelle: `handleStreamingResponse()` in `quivr-chat.js`
...
- `js/quivr-chat.js` - Hauptlogik (Button ist auskommentiert Zeile 429-430)
- `styles/quivr-chat.css` - CSS fuer Feedback-Container (Zeile 276-299)
